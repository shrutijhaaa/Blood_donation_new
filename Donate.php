...
// Include Twilio's PHP Helper Library (make sure it's installed via Composer)
            ...
            if ($conn->query($sql) === TRUE) {
                ...
                try {
                    ...
                    $client->messages->create(
                        ...
                        array(
                            'from' => '+19382538803',
                            'body' => "Dear $name, thank you for registering to donate blood on $date at $time. Please visit your nearest blood donation camp. We can't wait to see you. Warm regards, The Blood Donation team!"
                        )
                    );
                    $message .= " SMS notification has been sent.";
                } catch (Exception $e) {
