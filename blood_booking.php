                    ...
                    if ($stmt->execute()) {
                        ...
                        try {
                            $sms = $client->messages->create(
                                ...
                                [
                                    'from' => $twilio_number,
                                    'body' => "Thank you, $name! Your blood booking is done for $date at $time. Further details will be provided when you arrive at the blood bank center."
                                ]
                            );
